...
import { updateInvoiceAction, ActionState } from '@/app/lib/actions/invoice-actions';
import { Invoice } from '@/app/lib/types/Invoice';

export function EditInvoiceForm({ record }: { record: Invoice }) {
  const closeRef = useRef<HTMLButtonElement>(null);
  const updateWithKeys = updateInvoiceAction.bind(null, record.id);
