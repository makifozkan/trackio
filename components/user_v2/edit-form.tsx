...
import { updateUserV2Action, ActionState } from '@/app/lib/actions/user_v2-actions';
import { UserV2 } from '@/app/lib/types/UserV2';

export function EditUserV2Form({ record }: { record: UserV2 }) {
  const closeRef = useRef<HTMLButtonElement>(null);
  const updateWithKeys = updateUserV2Action.bind(null, record.id);
