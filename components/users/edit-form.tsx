...
import { updateUsersAction, ActionState } from '@/app/lib/actions/users-actions';
import { Users } from '@/app/lib/types/Users';

export function EditUsersForm({ record }: { record: Users }) {
  const closeRef = useRef<HTMLButtonElement>(null);
  const updateWithKeys = updateUsersAction.bind(null, record.id);
