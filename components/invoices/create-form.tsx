...
import { createInvoicesAction, ActionState } from '@/app/lib/actions/invoices-actions';

export function CreateInvoicesForm() {
  ...
  const [state, formAction, isPending] = useActionState<ActionState, FormData>(
    async (prevState, formData) => {
      try {
        ...
        const res = await createInvoicesAction(prevState, formData);
        if (res.success) {
