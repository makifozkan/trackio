          ...
          <div className="flex flex-1 items-center justify-end md:justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <Link
                  className="block bg-blue-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-blue-700"
                  href="/login"
                >
                  Login
                </Link>
                ...
                <a
                  className="hidden bg-gray-100 px-5 py-2.5 text-sm font-medium text-blue-600 transition hover:text-blue-600/75 sm:block"
                  href="#"
                >
                  Register
                </a>
        ...
        <div className="mx-auto w-screen max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
          <div className="max-w-prose text-left">
            ...
            <div className="mt-4 flex gap-4 sm:mt-6">
              <a
                className="inline-block rounded-sm border border-blue-600 bg-blue-600 px-5 py-3 font-medium text-white shadow-xs transition-colors hover:bg-blue-700"
                href="#"
              >
                Get Started
              </a>
              ...
              <a
                className="inline-block rounded-sm border border-gray-200 px-5 py-3 font-medium text-gray-700 shadow-xs transition-colors hover:bg-gray-50 hover:text-gray-900"
                href="#"
              >
                Learn More
              </a>
