...
export default function LoginForm() {
  ...
  const [googleSiginErrorMessage, googleSigninAction, isGoogleSigninPending] = useActionState(
    googleSignin,
    undefined
  );
  const [appleErrorMessage, appleSigninAction, isAppleSigninPending] = useActionState(
    appleSignin,
    undefined
  );
  const [githubErrorMessage, githubSigninAction, isGithubSigninPending] = useActionState(
    githubSignin,
    undefined
  );
          ...
          <div>
            <label htmlFor="email">
              ...
              <input
                ...
                required
                className="mt-0.5 w-full rounded-sm border-gray-300 shadow-xs sm:text-sm"
              />
            </label>
          </div>
          <div className="mt-4">
