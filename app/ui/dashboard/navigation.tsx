          ...
          <nav className="flex-1 space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-1">
                 <li>
                  <Link href="/dashboard/projects" className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-gray-600 rounded-xl hover:bg-white hover:text-indigo-600 transition-all">
                    Active Projects
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/explorer" className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-gray-600 rounded-xl hover:bg-white hover:text-indigo-600 transition-all">
                    Market Research
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-auto pt-8 border-t border-gray-200/50">
            <div className="flex items-center gap-3 px-2 mb-6">
              ...
              <div className="min-w-0">
                <p className="text-xs font-semibold text-gray-900 truncate">{user?.name || 'User Name'}</p>
