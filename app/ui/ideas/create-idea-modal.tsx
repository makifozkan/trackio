...
import { XMarkIcon, PlusIcon, TagIcon, DocumentTextIcon, CheckIcon } from '@heroicons/react/24/outline';
            ...
            <form action={formAction} className={clsx(
                ...
                <div className="flex-1 overflow-y-auto px-6 py-8 space-y-8">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="title" className="text-sm font-semibold text-gray-900 uppercase tracking-wider flex items-center gap-2">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="description" className="text-sm font-semibold text-gray-900 uppercase tracking-wider flex items-center gap-2">
                    ...
                    {/* Tags Input */}
                    <div className="space-y-2">
                        <label htmlFor="keywords" className="text-sm font-semibold text-gray-900 uppercase tracking-wider flex items-center gap-2">
