            ...
            <div className="flex-1 bg-white border border-slate-100 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mt-3 pt-3 border-t border-slate-50">
                ...
                <div className="md:col-span-4 flex flex-col justify-start">
                  <label className="text-[10px] font-bold uppercase text-slate-400 block mb-1">Assigned To</label>
                  <div className="flex -space-x-2 overflow-hidden">
                    <img alt="Member" className="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAOwHP9FBxlMvT_2eV2mwKpFSZ4kcJmeWkFbu0xAosGirjezHfmefvQUz-NSflglRes1hhxGjiTlcnN3auovaJDdBN55v8JInpu35rjXRNf6YLk4XYf0n-yAkn4zokMrbZGgw-eOKgN1ASwfmlzZlNn_hX_59hH3xQQhN3U1iou8mwE3tLgME8iZS5N_mdgiJ_Kt-gfA90Jcm_9wjCkHDfRSiEoJSPcYWWStFcg4fMRA7F_NpDTEFC6AOour64KdtcAlLb5KF8Qmw" />
                    <img alt="Member" className="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCDBCfeGjMvsCH9-B67-0aJnNvjP0QtvICNuky4SHTr-r-bBCIHN-6qAwi49HF9TTwQkQwEPNCs42kHYm156OlqZ6B24XdsAuKvjIX91h7Gk5LMHkjY2Qgn_L49ndQ52tBXcksJ2dprR8TDju6HvCb7vwYC-mwTXOqZpiIMdpdiQoW6DUVzqBeL9ed4rDB12vWIH61gkpqgBV2iEZpy9IYwU1eeEQIOmQguT-tAWEmdCGtJChdVmtUrKjtCJre9Eohv8TLtLgcf6A" />
                    <button type="button" className="h-6 w-6 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-[10px] font-bold text-slate-500 hover:bg-sky-50 transition-colors">+2</button>
                  </div>
                </div>
              </div>
            </div>
