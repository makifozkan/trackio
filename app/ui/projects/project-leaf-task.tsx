...
export default function ProjectLeafTask() {
  return (
    <div className="relative tree-line tree-line-node">
      <div className="flex items-center gap-4 group">
        <div className="flex-1 bg-slate-50/50 border border-slate-100 rounded-xl p-3 flex items-center justify-between hover:bg-white hover:border-sky-100 transition-colors">
          ...
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              className="p-1 hover:text-sky-600 text-slate-400 rounded-sm transition-colors"
              title="Edit Sub-task"
            >
              <Edit className="text-base" />
            </button>
            <button
              className="p-1 hover:text-red-500 text-slate-400 rounded-sm transition-colors"
