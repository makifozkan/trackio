  ...
  return (
    <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between border-b border-gray-100 pb-8">
      <div className="max-w-2xl">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 md:text-4xl">Projects</h1>
        <p className="mt-4 text-lg text-gray-600 leading-relaxed">
          Central hub for project management. Browse existing projects, create new ones, and monitor
          project status and milestones at a glance.
        </p>
      </div>
      <button
        type="button"
